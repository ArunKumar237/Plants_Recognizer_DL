...
if uploaded_file is not None:
    ...
    if argmax_index[0] == 0:
        ...
        with col1:
            st.image(image, caption='predicted: Prunus_\u00d7_Shmittii')
        with col2:
            st.markdown(download_desc('Prunus_\u00d7_Shmittii'.lower()))
        ...
        with col1:
            st.image(image, caption='predicted: Quercus_\u00d7_Hispanica')
        with col2:
            st.markdown(download_desc('Quercus_\u00d7_Hispanica'.lower()))
    elif argmax_index[0] == 88:
        with col1:
            st.image(image, caption='predicted: Quercus_\u00d7_Turneri')
        with col2:
            st.markdown(download_desc('Quercus_\u00d7_Turneri'.lower()))
    elif argmax_index[0] == 89:
        with col1:
            st.image(image, caption='predicted: Rhododendron_\u00d7_Russellianum')
        with col2:
            st.markdown(download_desc('Rhododendron_\u00d7_Russellianum'.lower()))
        ...
        with col1:
            st.image(image, caption='predicted: Viburnum_\u00d7_Rhytidophylloides')
        with col2:
            st.markdown(download_desc('Viburnum_\u00d7_Rhytidophylloides'.lower()))
    else :
        with col1:
